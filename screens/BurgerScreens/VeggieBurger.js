...
// Import your icons
import Burger from "../../assets/images/BIG-veggie-burger.png";
...
const WendyBurgerScreen = () => {
  ...
  const basePrice = 9.99; // Base price for one portion
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        <Text style={styles.ItemName}>Hamburger Veggie Burger</Text>
        <View style={styles.ItemRating}>
          <Image source={StarRating} style={styles.StarIcon} />
          <Text>4.8 - 14 mins</Text>
        </View>
        <Text style={styles.ItemDescription}>
          Enjoy our delicous Hambuger Veggie Burger, made with a savory blend of
          fresh vegetables and herbs, topped with crisp lettuce, juicy tomatoes,
