...
// Import your icons
import Burger from "../../assets/images/BIG-friedchicken-burger.png";
...
const WendyBurgerScreen = () => {
  ...
  const basePrice = 6.7475; // Base price for one portion
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        <Text style={styles.ItemName}>Fried Chicken Burger</Text>
        <View style={styles.ItemRating}>
          <Image source={StarRating} style={styles.StarIcon} />
          <Text>4.5 - 14 mins</Text>
        </View>
        <Text style={styles.ItemDescription}>
          Indulge in our cripsy and savory Fried Chicken Burger, made with a
          juicy chicken patty, hand-breaded and deep-fried to perfection, served
          on a warm bun with lettuce, tomato, and a creamy sauce.
        </Text>
      </View>
